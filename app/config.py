...
IMPORT_MAX_ALBUMS_PER_ARTIST = get_int_env("IMPORT_MAX_ALBUMS_PER_ARTIST", 100)
IMPORT_MAX_ALBUM_TRACKS_PER_ARTIST = get_int_env("IMPORT_MAX_ALBUM_TRACKS_PER_ARTIST", 1000)
